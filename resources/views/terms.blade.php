@extends('layouts.master', ['title' => 'Termos'])
...
<p>Esse site é operado pelo {{ config('app.name', 'Laravel') }}. Em todo o site, os termos “nós”, “nos” e “nosso” se referem ao {{ config('app.name', 'Laravel') }}. O {{ config('app.name', 'Laravel') }} proporciona esse site, incluindo todas as informações, ferramentas e serviços disponíveis deste site para você, o usuário, com a condição da sua aceitação de todos os termos, condições, políticas e avisos declarados aqui.</p>
...
<br>
<h4>SEÇÃO 13 - ISENÇÃO DE RESPONSABILIDADE DE GARANTIAS; LIMITAÇÃO DE RESPONSABILIDADE</h4>
...
<p>Esses Termos de serviço e quaisquer acordos separados em que nós lhe fornecemos os Serviços devem ser regidos e interpretados de acordo com as leis de Centro, Ourinhos, SP, 19900000, Brazil.</p>
...
<p>As perguntas sobre os Termos de serviço devem ser enviadas para nós através do contactus.smarket@gmail.com.</p>
            </div>
